...
def bartlett(sigma, T, S, K, r, q, ds, beta, volvol, rho):
    ...
    bs_price1, bs_delta, bs_gamma, bs_theta   = bs_call(vol1, T, S, K, r, q)
    bs_price2, bs_delta, bs_gamma, bs_theta = bs_call(vol2, T, S+ds, K, r, q)
...
def get_sim_path_sabr(M, freq, np_seed, num_sim):
    ...
    bs_price, bs_delta, bs_gamma, bs_theta  = bs_call(implied_vol, ttm / T, a_price, K, r, q)
